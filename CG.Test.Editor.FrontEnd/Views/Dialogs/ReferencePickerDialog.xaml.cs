...
namespace CG.Test.Editor.FrontEnd.Views.Dialogs
{
	...
	public class NodeFromPairConverter : ValueConverterBase<NodeViewModelBase?, NodeEntryViewModel?>
	{
        public override NodeEntryViewModel? Convert(NodeViewModelBase? node) => node is null ? null : new NodeEntryViewModel()
		{ 
