...
namespace CG.Test.Editor
{
    public static class Extensions
    {
        ...
        public static int ShowMessage(this Window ownerWindow, string message, string title = "", int defaultButtonIndex = 0, string first = "OK", params string[] buttons)
        {
            if (_isOpen)
            {
        ...
        public static void SetRecursive(this TreeViewItem item, Action<TreeViewItem> modifier)
        {
            modifier(item);
